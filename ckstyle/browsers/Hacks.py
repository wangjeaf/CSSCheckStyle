...
RULE_HACKS = [
    ...
    #re.compile( auto generate by script AUTO-GENERATOR-1 .
...
RULESET_HACKS = [
    ...
    [re.compile(r'.*\-ms\-'),               1, IE9PLUS],
    [re.compile(r'.*\-o\-'),                1, OPERA],
    #re.compile( auto generate by script AUTO-GENERATOR-2 .
    [re.compile(r'.+:first\-line'), 1, NOIE6],
    [re.compile(r'.+:first\-letter'), 1, NOIE6],
    [re.compile(r'\..+\..+'), 2, NOIE6],
...
if __name__ == '__main__':
    print(bin(doRuleSetDetect('.test:first-letter')))
